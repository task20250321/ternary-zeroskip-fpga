...
module ternary_zeroskip_pe_owned_emif_wrapper #(
    ...
    // Compatibility parameters retained so top/zeroskip_top.sv can switch
    // wrapper names without changing its existing parameter list.
    ...
    ternary_zeroskip_pe_owned_accelerator #(
        .NUM_PE                  (NUM_PE),
